...
var lexerTests = []lexerTest{
	...
	{"builtins",
		"strptime\ntimestamp\ntolower\nlen\nstrtol\nsettime\ngetfilename\nint\nbool\nfloat\nstring\n", []token{
			...
			token{BUILTIN, "int", position{"builtins", 7, 0, 2}},
			token{NL, "\n", position{"builtins", 8, 3, -1}},
			token{BUILTIN, "bool", position{"builtins", 8, 0, 3}},
			token{NL, "\n", position{"builtins", 9, 4, -1}},
			token{BUILTIN, "float", position{"builtins", 9, 0, 4}},
			token{NL, "\n", position{"builtins", 10, 5, -1}},
			token{BUILTIN, "string", position{"builtins", 10, 0, 5}},
			token{NL, "\n", position{"builtins", 11, 6, -1}},
			token{EOF, "", position{"builtins", 11, 0, 0}}}},
